        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPaymentMethods_PaymentType_PaymentTypeId",
                        column: x => x.PaymentTypeId,
                        principalTable: "PaymentType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserPaymentMethods_Provider_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Provider",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserPaymentMethods_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFiles_ProductItem_ProductItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPaymentMethodId = table.Column<int>(type: "int", nullable: true),
                    AddressId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Order_UserPaymentMethods_UserPaymentMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_UserPaymentMethodId",
                table: "Order",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFiles_ProductItemId",
                table: "ProductFiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPaymentMethods_ProviderId",
                table: "UserPaymentMethods",
                column: "ProviderId");
